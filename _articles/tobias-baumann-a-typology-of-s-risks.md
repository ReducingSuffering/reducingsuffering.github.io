...
- Каковы наиболее значимые [факторы риска](https://centerforreducingsuffering.org/research/risk-factors-for-s-risks/), увеличивающие вероятность реализации различных s-рисков или масштаб ущерба в случае их реализации?
