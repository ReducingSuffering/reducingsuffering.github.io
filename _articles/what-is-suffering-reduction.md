...
2.4. Не в рамках какого-то одного выбранного сценария будущего (где якобы "все пойдет по плану"), а _с учетом вариативности_;<br>
3\. Это не то, что можно сделать один раз и забыть, а _систематически повторяющийся_ вид поведения.
