...
original_date:
  - 2024.01.02
---
В данной статье мы постараемся популярно, но при этом достаточно подробно объяснить, что понимается под _уменьшением страданий_ (или, что обычно тоже самое, _минимизацией страданий_) в современном [(негативно) утилитарном](https://reducingsuffering.github.io/71.html) дискурсе.
...
[5.2.4. Типичные ошибки](#5.2.4)<br>
[6. Модификации](#6)<br>
...
Агент может сознательно решать задачу минимизации страданий в той или иной ситуации, но серьезно ошибаться, несмотря на субъективную оптимальность его решения. Чтобы объяснить смысл ошибок и научиться оценивать их величину, нужно ввести какую-то _объективную_ меру качества решений.
...
Мы не будем сильно углубляться в эту тему, однако обратим внимание на некоторые важные моменты, чтобы интересующимся было с чего начать свой поиск.
...
Чтобы оценить важность проекта, нужно перемножить эти три величины.
...
К сожалению, описанные выше величины будут поддаваться хорошей оценке лишь в некоторых случаях — например, при анализе эффективности благотворительных организаций (да и в таком анализе их [может быть недостаточно](https://blog.givewell.org/2011/08/18/why-we-cant-take-expected-value-estimates-literally-even-when-theyre-unbiased/)).

В случаях, которые фокусируются на попытках повлиять на далекое будущее или предполагают исследовательскую работу, оценки делать намного сложнее. Однако, даже наши интуитивные оценки этих величин могут помочь.

<a name="5.2.4"></a>
#### 5.2.4. Типичные ошибки

Ранее уже было отмечено, что задачу глобального уменьшения страданий неудобно редуцировать к одним только задачам локального уменьшения страданий; часто лучше фокусироваться на инструментальных ценностях, а также соблюдать различные ограничения на допустимые методы решения задач с локальными масштабами.

Но какими могут быть примеры такой неудачной редукции? Это ситуации, когда агенты фокусируются на отдельных областях пространственно-временной действительности, игнорируя другие.

Например, аргументация вида "люди очень страдают от болезни X, поэтому нам нужно заняться разработкой лекарства от X" не содержит никакой информации о действительности за пределами страдающих от определенной болезни людей, поэтому не может считаться самодостаточной. Нам нужна информация об окружающем мире, чтобы мы могли _сравнивать_ разработку лекарства с другими вариантами возможной деятельности.

Другой пример — это "если ты так хочешь уменьшить страдания, почему не начнешь с себя и не [умрешь](https://reducingsuffering.github.io/73.html)?" — в этом случае происходит безосновательная фокусировка на страданиях одного-единственного агента. Помимо этого, вопрошающие могут недооценивать риск того, что попытки ускорить смерть могут привести к еще большим мучениям этого агента, чем в случае с доживанием до естественной смерти.

Отдельный интерес представляют ошибочные рассуждения вида "при идеальном миропорядке нет страданий -> чтобы уменьшить страдания, нужно стремиться приблизить идеальный миропорядок" (типичные варианты "идеального миропорядка" — это либо опустошенный мир, либо [гедонистическая утопия](https://reducingsuffering.github.io/89.html)). Несмотря на кажущуюся попытку позаботиться обо всех существах сразу, это рассуждение, как и предыдущие, само по себе не указывает никаких преимуществ предлагаемого курса действий по сравнению с альтернативами.

Что же выяснится, если сравнивать эти проекты с другими? Есть аргументы в пользу некоторой [ограниченной поддержки](https://magnusvinding.com/2021/08/09/reasons-not-to-prioritize-the-abolitionist-project/) проекта гедонистической утопии. Но вот проекты вымирания, с другой стороны, [крайне проблематичны](https://forum.effectivealtruism.org/posts/JnHeeTGAohMFxNbGK/peacefulness-nonviolence-and-experientialist-minimalism), и в некоторых случаях способны [саботировать](https://reducingsuffering.github.io/450.html) весь реальный прогресс в уменьшении страданий.
...
В гедонистическом утилитаризме моральный круг охватывает всех сентиентных существ. При этом, фундаментальный для утилитаризма принцип равного рассмотрения интересов подразумевает, что одинаковые страдания разных персон должны давать один и тот же вклад в общие оценки страданий.
